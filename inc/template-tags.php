...
if (!function_exists('wp_bootstrap_4_post_thumbnail')) :
	...
	function wp_bootstrap_4_post_thumbnail()
	{
		...
		?>
			...
			<div class="post-thumbnail-paralax" style="background-image:url(<?= get_the_post_thumbnail_url() ?>); background-repeat:no-repeat; background-size:cover; background-attachment:fixed">
				&nbsp;
			</div><!-- .post-thumbnail -->
		...
		<?php else : ?>
			...
			<a class="post-thumbnail" href="<?php the_permalink(); ?>" aria-hidden="true">
				<?php
				get_the_post_thumbnail('post-thumbnail', array(
